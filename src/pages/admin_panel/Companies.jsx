...
//         <div className="flex justify-between items-center mb-10 p-4 shadow">
//           <h1 className="text-[2.2rem] font-bold text-white">Companies</h1>
//           <button
...
//             <thead className="bg-gray-700 text-[1rem] text-white">
//               <tr>
...
//                 <tr key={company.id} className="hover:bg-[#364153] transition">
//                   <td className="p-3">
//                     {company.logo ? (
//                       <img
//                         src={company.logo}
